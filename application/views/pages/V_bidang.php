<div class="col-12">
    ...
    <div class="card" style="border-radius: 10px;">
        <div class="card-body">
            <h2>List Bidang <button class="btn btn-warning btn-round" data-toggle="modal" data-target="#modal-add">Add Bidang</button></h2>
            <hr class="my-2">
                    ...
                    <tbody>
                        ...
                        foreach ($listdata->result() as $row_data) { ?>
                            <tr>
                                ...
                                <td><?php echo $row_data->pegawai_nama; ?></td>
                                <td>
                                    <div class="btn-group ">
...
<div class="modal modal-center fade" id="modal-add" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url(); ?>admin/bidang/add" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="id_kasi">Kasi</label>
                        <select class="form-control" name="id_kasi" id="id_kasi" required>
...
<div class="modal modal-center fade" id="modal-edit" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url(); ?>admin/bidang/update" method="POST">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="id_kasi_update">Kasi</label>
                        <select class="form-control" name="id_kasi" id="id_kasi_update" required>
                            <option value="">Pilih Pegawai</option>
                            <?php foreach ($listpegawai->result() as $row_pegawai) { ?>
                                <option value="<?php echo $row_pegawai->id; ?>"><?php echo $row_pegawai->nama; ?></option>
                            <?php } ?>
...
<div class="modal modal-center fade" id="modal-delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url(); ?>admin/bidang/delete" method="POST">
                <div class="modal-header">
...
<script>
    function getview(id) {
        $.getJSON("<?php echo base_url(); ?>admin/bidang/view/" + id, function(data) {
            // console.log(data);
            $("#id_update").val(data.id);
            $("#nama_update").val(data.nama);
            $("#id_kasi_update").val(data.id_kasi);
        });
    }
