<div class="col-12">
    ...
    <div class="card" style="border-radius: 10px;">
        <div class="card-body">
            <h2>List Pangkat <button class="btn btn-warning btn-round" data-toggle="modal" data-target="#modal-add">Add Pangkat</button></h2>
            <hr class="my-2">
...
<div class="modal modal-center fade" id="modal-add" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url();?>admin/pangkat/add" method="POST">
...
<div class="modal modal-center fade" id="modal-edit" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url();?>admin/pangkat/update" method="POST">
                <div class="modal-header">
...
<div class="modal modal-center fade" id="modal-delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url();?>admin/pangkat/delete" method="POST">
                <div class="modal-header">
...
<script>
    function getview(id) {
        $.getJSON("<?php echo base_url();?>admin/pangkat/view/" + id, function(data) {
            // console.log(data);
